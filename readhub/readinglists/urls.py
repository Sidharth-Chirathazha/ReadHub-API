...
from .views import ReadingListViewSet, AddBookToReadingList, RemoveBookFromReadingList, RearrangeReadingListItems
...
urlpatterns = [
    ...
    path('reading-lists/<int:reading_list_id>/rearrange-items/', RearrangeReadingListItems.as_view(), name='rearrange-items'),
]